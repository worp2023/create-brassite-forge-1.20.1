...
public enum ModArmorMaterials implements ArmorMaterial {
    BRASSITE("brassite",26,new int[]{4,9,6,3},25, SoundEvents.ARMOR_EQUIP_GOLD,3f,1f,()-> Ingredient.of(ModItems.BRASSITE_INGOT.get()));
    ...
    public String getName() {
        return CreateBrassiteForge.MOD_ID + ":" + this.name;
    }
